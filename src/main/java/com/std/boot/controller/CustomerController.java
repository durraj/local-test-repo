...
import com.std.boot.repository.CustomerRepository;
import com.std.boot.service.FileArchiveService;
import com.std.common.exception.CustomerNotFoundException;
import com.std.common.exception.InvalidCustomerRequestException;
...
public class CustomerController {
	...
	public List<Customer> getCustomers() {
		 ...
		 for(@SuppressWarnings("unused") Customer customer:customers)
		 {
